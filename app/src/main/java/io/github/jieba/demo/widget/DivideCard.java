...
public class DivideCard extends LinearLayout implements TagFlowLayout.OnSelectListener,
    ...
    private final TextView mTranslate;

    private final TextView mSearch;
        ...
        mFlowLayout.setAdapter(new TagAdapter<String>(words) {
            ...
            public View getView(FlowLayout flowLayout, int i, String word) {
                TextView view = (TextView) LayoutInflater.from(mContext)
                    .inflate(R.layout.ui_divider_item, flowLayout, false);
                view.setText(word);
                return view;
            }
        });
    ...
    private void copyToClipboard() {
        ...
        ClipboardManager cbm = (ClipboardManager) mContext.getSystemService(
